...
public class ConversationListFragment extends EaseConversationListFragment {
	...
	protected void setUpView() {
		...
		//todo 会话列表  点击事件
		CommonUtils.setConversationItemClickListener(new CommonUtils.OnConversationItemClickListener() {
			@Override
		...
		//会话列表左滑删除
		CommonUtils.setOnConversationDeleteListener(new CommonUtils.OnConversationDeleteListener() {
			@Override
			public void onDeleteClick(EMConversation conversation) {
